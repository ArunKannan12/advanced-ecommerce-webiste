...
def payment(request):
    ...
    #store teansaction details inside payment model
    ...
    order.save()
    #move the cart ites to order product table
    ...
    for item in cart_items:
        ...
        orderproduct=OrderedProduct.objects.get(id=orderproduct.id)
...
def place_order(request,total=0,quantity=0):
    ...
    #if the cart count is less than or equal to 0 then rdirect back to shop
...
def order_complete(request):
    ...
    try:
        ...
        ordered_products=OrderedProduct.objects.filter(order_id=order.id)
